...
namespace QF_ALMACEN_API.Almacen.Distribucion
{
    public class DistribucionService
    {
        ...
        {
            return await _distribucionRepository.DistribucionAuditoriaDetalleAsync(nro_documento, idsucursal_origen, idsucursal_destino);
        }
        ...
        {
            return await _distribucionRepository.DistribucionBuscarGuiaAsync(nroDocumento, idSucursalOrigen, idSucursalDestino);
        }
        ...
        {
            return await _distribucionRepository.FraccionamientoSolicitudGuardarAsync(fraccionamiento);
        }
        ...
        {
            return await _distribucionRepository.FraccionamientoSolicitudAnularAsync(idfraccionamientoSolicitud, codigo_presentacion, usuario_anula);
        }

        public async Task<string> FraccionamientoSolicitudDescargarAsync(string fraccionamiento)
        {
            return await _distribucionRepository.FraccionamientoSolicitudDescargarAsync(fraccionamiento);
        }
